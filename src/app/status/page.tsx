...
const INCIDENTS = [
  { date: "2026-03-28", title: "Brief oracle lag on SOX3L", duration: "14 min", body: "Oracle update frequency dropped during a semiconductor earnings spike. No funds affected. Resolved by switching to backup oracle feed." },
