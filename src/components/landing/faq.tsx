...
const FAQ = [
  ...
  },
  {
    ...
    a: "Every market has both a long and an inverse side. TSL2L gives you 2× Tesla upside; TSL1S is the corresponding short. You don't need a margin account to switch direction — you just trade between two SPL tokens in your wallet.",
  },
  {
