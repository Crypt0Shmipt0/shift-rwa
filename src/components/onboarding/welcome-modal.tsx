...
const SLIDES = [
  ...
  },
  {
    ...
    body: "Every market ships with a long AND a short side. Buy TSL2L for 2× Tesla upside, or TSL1S to short. No margin account, no funding rate surprises, no liquidation cascades. Professional tokenized ETFs and ETNs, on-chain.",
  },
  {
    icon: ShieldCheck,
